...
/** Query flag `/` reads to surface the role-less bounce reason ([[adr-21-authorization-lobby]]). */
...
/**
 * The shared role gate for every authenticated page ([[adr-21-authorization-lobby]]
